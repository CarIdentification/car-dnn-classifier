...
flags.DEFINE_string('ps_hosts', 'localhost:22221', 'Comma-separated list of hostname:port pairs')
# 两个worker节点
flags.DEFINE_string('worker_hosts', 'localhost:22222,localhost:22223',
...
# 选择异步并行，同步并行
flags.DEFINE_integer("issync", 0, "是否采用分布式的同步模式，1表示同步模式，0表示异步模式")
